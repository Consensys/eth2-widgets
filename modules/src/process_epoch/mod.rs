...
pub fn process_epoch(pre_state: State, epoch_number: i32, output: &mut Output) -> State {
    ...
    let total_at_stake_initial = 1 as u64 * 1_000_000 * 1_000_000_000;
    output_row.network_percentage_rewards = ((post_state.get_total_staked_balance() as f64 - post_state.get_total_active_balance() as f64) / post_state.get_total_active_balance() as f64) * 100 as f64;
