...
* @returns {number}
*/
export function get_validator_rewards(_total_eth_staked, _average_validators_online) {
    uint64CvtShim[0] = _total_eth_staked;
    const low0 = u32CvtShim[0];
    const high0 = u32CvtShim[1];
    var ret = wasm.get_validator_rewards(low0, high0, _average_validators_online);
    return ret;
}
...
* @returns {any}
*/
export function get_network_rewards(_total_eth_staked, _online_probability, _honest_probability) {
    var ret = wasm.get_network_rewards(_total_eth_staked, _online_probability, _honest_probability);
